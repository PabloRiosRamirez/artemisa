...
@Component
public class ScoreServiceActivator extends BasicRestServiceActivator {
    ...
    public Map<String, Object> invoke(@Payload Map<String, Object> payload, @Headers Map<String, Object> header) throws Exception {
		ResponseEntity<Map<String, Object>> responseEntity = consumerRestServiceActivator("/api/poseidon/score", HttpMethod.POST, payload, new HashMap<>(), microservicePoseidon);
